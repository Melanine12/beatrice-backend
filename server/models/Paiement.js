...
module.exports = (sequelize) => {
  ...
  Paiement.associate = (models) => {
    Paiement.belongsTo(models.User, { foreignKey: 'employe_id', as: 'Employe' });
    Paiement.belongsTo(models.User, { foreignKey: 'valide_par', as: 'Validateur' });
    Paiement.belongsTo(models.User, { foreignKey: 'created_by', as: 'Createur' });
    Paiement.belongsTo(models.User, { foreignKey: 'updated_by', as: 'Modificateur' });
  };
