...
async function autoGenerateDemandeAffectationForStockHouseKeeping() {
  try {
    ...
    console.log(`✅ Espace trouvé: ${stockHousekeepingChambre.numero} (ID: ${stockHousekeepingChambre.id})`);
    ...
    mouvements.forEach(mouvement => {
      if (mouvement.inventaire && !articlesMap.has(mouvement.inventaire.id)) {
        articlesMap.set(mouvement.inventaire.id, {
          ...
          stock_minimum: mouvement.inventaire.stock_minimum,
    ...
    for (const article of articles) {
      ...
      // Générer une demande si la quantité restante est <= stock minimum (pas seulement 0)
